...
\- Add an empty file `New\_Notes.md` in the `raw/` file to collect new notes.
...
This vault is published as a MkDocs site on GitHub Pages. After ingesting new notes:
...
\- Keep page names Title Case with underscores (e.g. `Machine\_Learning.md`).
